...
import { H as HYDRATION_START, a as HYDRATION_ERROR, b as HYDRATION_END, P as PassiveDelegatedEvents, r as render, p as push$1, s as setContext, c as pop$1 } from "./index2.js";
let base = "";
let assets = base;
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon-32x32.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover" class="font-redHatText bg-rose-50 text-Rose-900">\n		<div class="container p-6 lg:p-20 mx-auto">' + body + "</div>\n	</body>\n</html>\n",
